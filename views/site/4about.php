...
<div id="about">
	<div class="container">
		...
		<div class="col-sm-12 row">
			<div class="col-sm-6" style="padding: 0 80px; text-align: center">
				<?php
					$img2 = Html::img('@web/images/why2.svg', ['width' => '60%', 'style' => 'margin-bottom: 10px;']);
					...
					echo Html::a($img2 . '<br>' . $text1 . '<br>' . $text2, '', ['id' => 'sokov']);
				?>
			</div>
			<div class="col-sm-6" style="padding: 0 80px; text-align: center">
				<?php
					...
					$text2 = Html::tag('span', 'Юрист', ['style' => 'color: #555']);
					echo Html::a($img2 . '<br>' . $text1 . '<br>' . $text2, '', ['id' => 'kuzmenko']);
				?>
			</div>
		</div>
